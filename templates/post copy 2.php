            ...
            <div class="card">
                <div class="card-image">
                    <div class="music-player">
                        <img src="<?php echo $globalitem['image_path']; ?>" alt="Song Cover" class="cover">
                        <div class="info">
                ...
                <div class="card-title">
                    <h3><a href="content.php?itemID=<?php echo $itemID; ?>"><?php echo $globalitem['name']; ?></a></h3>
                </div>
                <div class="card-body">
                    <p><?php echo $globalitem['description']; ?></p>
                </div>
...
function display_section($countPost){
    ...
    echo "<ul>channel</ul>";
    echo "</div>";
    echo "<h3>Showing: $countPost posts</h3>";
